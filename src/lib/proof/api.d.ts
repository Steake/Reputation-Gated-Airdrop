...
export declare class ProofAPI {
     ...
     */
    requestProof(attestations: TrustAttestation[], proofType: "exact" | "threshold", options?: {
     ...
     */
    requestProofWithWebSocket(attestations: TrustAttestation[], proofType: "exact" | "threshold", websocketUrl: string, options?: {
        priority?: ProofPriority;
        userId?: string;
        onProgress?: (progress: ProofGenerationProgress) => void;
    }): Promise<ProofResult>;
