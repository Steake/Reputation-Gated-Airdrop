...
export declare class ProofGenerationError extends Error {
    ...
    constructor(message: string, type: ProofErrorType, severity?: ProofErrorSeverity, recoverability?: ProofErrorRecoverability, metadata?: Partial<ProofErrorMetadata>, originalError?: Error);
    /**
