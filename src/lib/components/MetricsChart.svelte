  ...
  <div class="flex items-center justify-between mb-6">
    ...
    <div class="flex items-center space-x-4">
      {#if type === 'global'}
        <div class="flex items-center space-x-6 text-sm">
          <div class="text-center">
            <div class="text-2xl font-bold text-blue-600">{globalMetrics.totalUsers.toLocaleString()}</div>
            <div class="text-gray-500 dark:text-gray-400">Total Users</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-green-600">{(globalMetrics.averageScore * 100).toFixed(1)}%</div>
            <div class="text-gray-500 dark:text-gray-400">Avg Score</div>
          </div>
          <div class="text-center">
            <div class="text-2xl font-bold text-purple-600">{globalMetrics.activeUsers.toLocaleString()}</div>
      ...
      {:else}
        <div class="flex items-center space-x-6 text-sm">
          <div class="text-center">
            <div class="text-2xl font-bold text-purple-600">{(userMetrics.currentScore * 100).toFixed(1)}%</div>
