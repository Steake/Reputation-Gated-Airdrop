        ...
        {#if $walletMock.enabled}
          ...
          <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            ...
            <div class="space-y-2 text-sm">
              ...
              {#if $walletMock.error}
                <div
                  class="text-red-600 dark:text-red-400 text-xs bg-red-50 dark:bg-red-900/20 p-2 rounded"
                >
                  {$walletMock.error}
                </div>
              {/if}
            ...
            <div class="space-y-2">
              <label class="flex items-center">
                <input
                  ...
                  on:change={(e) =>
                    walletMockActions.setConnectionBehavior(
                      e.currentTarget.checked,
                      $walletMock.autoFailConnection
                    )}
                  class="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
              ...
              <label class="flex items-center">
                <input
                  ...
                  on:change={(e) =>
                    walletMockActions.setConnectionBehavior(
                      $walletMock.simulateSlowConnection,
                      e.currentTarget.checked
                    )}
                  class="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
