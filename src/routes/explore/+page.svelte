...
<div class="max-w-7xl mx-auto">
  ...
  <div class="text-center mb-12">
    ...
    <h1 class="page-title text-[var(--fg-primary)] mb-4">Reputation Analytics</h1>
    <p class="text-lg text-[var(--fg-secondary)] max-w-2xl mx-auto">
      Explore global reputation trends, user metrics, and trust network relationships through
  ...
  <section class="mb-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div
        class="card-elevated bg-gradient-to-br from-[var(--accent-info)]/5 to-[var(--accent-brand)]/5
      ...
      <div
        class="card-elevated bg-gradient-to-br from-[var(--accent-success)]/5 to-[var(--accent-info)]/5
  ...
  <section class="mb-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div
        class="card-elevated bg-gradient-to-br from-[var(--accent-brand)]/5 to-[var(--accent-warn)]/5
      ...
      {#if $wallet.connected}
        <div
          class="card-elevated bg-gradient-to-br from-[var(--accent-warn)]/5 to-[var(--accent-brand)]/5
      ...
      {:else}
        ...
        >
          <div class="text-center">
            ...
            <a href="/" class="btn-primary inline-flex items-center"> Connect Wallet </a>
          </div>
        </div>
      {/if}
    </div>
  ...
  <section class="mb-16">
    <div class="card bg-gradient-to-r from-[var(--bg-surface)] to-[var(--bg-surfaceElev)]">
      <h3 class="text-18 text-[var(--fg-primary)] mb-6 text-center">Network Statistics</h3>
