...
declare module '$env/static/private' {
	...
	export const TOKEN_ADDR: string;
	export const CAMPAIGN: string;
	export const FLOOR_SCORE: string;
	export const CAP_SCORE: string;
	export const CURVE: string;
	export const MIN_PAYOUT: string;
	export const MAX_PAYOUT: string;
	...
	export const QNN_SDK_ROOT: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_FLOOR_SCORE: string;
	export const PUBLIC_CAP_SCORE: string;
	export const PUBLIC_CURVE: string;
	export const PUBLIC_MIN_PAYOUT: string;
	export const PUBLIC_MAX_PAYOUT: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_FLOOR_SCORE: string;
		PUBLIC_CAP_SCORE: string;
		PUBLIC_CURVE: string;
		PUBLIC_MIN_PAYOUT: string;
		PUBLIC_MAX_PAYOUT: string;
