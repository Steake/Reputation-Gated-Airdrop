...
**I want to** validate zero-knowledge proofs  
**So that** I can trust the claimed reputation scores

#### Scenario: On-chain proof verification
**Given** a ZK proof with public inputs [reputation_score, merkle_root]  
**When** the proof is submitted to the verification contract  
